...
export default function Refund({ }: Props) {
    return (
        <div>
            ...
            Last updated on 31-07-2024 23:34:40
            BASHIR MEHBOOB SHAIKH believes in helping its customers as far as possible, and has therefore a
            ...
            • BASHIR MEHBOOB SHAIKH does not accept cancellation requests for perishable items like flowers,
            ...
            the issue to them. In case of any Refunds approved by the BASHIR MEHBOOB SHAIKH, it’ll take 3-5
